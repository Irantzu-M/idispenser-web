...
const ModalSensorConfirm = (props) => {
      ...
      {open && (
        <ClayModal observer={observer} size="md" center={true} status="info">
          {confirmType == "modify" && (
            <>
              <ClayModal.Body className="text-center pt-5 px-5">
                <p>¿Desea modificar los datos del Sensor?</p>
              </ClayModal.Body>
              <ClayModal.Footer
          ...
          {confirmType == "delete" && (
            <>
              <ClayModal.Body className="text-center pt-5 px-5">
                <p>¿Está seguro de que desea eliminar el Sensor?</p>
              </ClayModal.Body>
              <ClayModal.Footer
                className="justify-content-center  pb-5"
                last={
...
export default ModalSensorConfirm;
